...
export function LoginForm({ fixtureMode, onSubmit }: LoginFormProps) {
  ...
  function fillFixtureCredentials() {
    updateIdentifier(FIXTURE_ADMIN_CREDENTIALS.email);
    updatePassword(FIXTURE_ADMIN_CREDENTIALS.password);
  }
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setServerError(isApiError(error)
        ? error.userMessage
      ...
      <div className="auth-field">
        ...
        <div className="auth-input-wrap">
          ...
          <input
            ...
            id="admin-identifier"
            name="identifier"
            placeholder="admin@tihamah.com"
            type="text"
            value={identifier}
            aria-describedby={fieldErrors.identifier ? "admin-identifier-error" : undefined}
      ...
      {fixtureMode && (
        <div className="fixture-login-note">
          <div>
            ...
            <code dir="ltr">{FIXTURE_ADMIN_CREDENTIALS.email}</code>
            <code dir="ltr">{FIXTURE_ADMIN_CREDENTIALS.password}</code>
          </div>
          <button type="button" onClick={fillFixtureCredentials}>
