...
export function CategoriesPage() {
  ...
  return (
    <>
      <PageHeader title="إدارة الأقسام" description="تعديل الأقسام التي تظهر في التطبيق والتحكم بأيقوناتها وترتيبها وحالتها." action={<button className="button" type="button" onClick={() => openEditor("new")}><Plus size={17} />إضافة قسم</button>} />
